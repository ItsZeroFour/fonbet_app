        ...
        <div className={`wrapper ${style.start__wrapper}`}>
          ...
          <ul>
            ...
            <li>
              ...
              <p>
                Станьте футбольным скаутом и покупайте в свой клуб только тех
                игроков, кто подходит под требования тренерского штаба.
              </p>
            </li>
            ...
            <li>
              ...
              <p>
                Сможете ли вы пройти путь от стажировки в середняке РПЛ до
                работы в европейском топе?
              </p>
            </li>
          </ul>
